...
export const etkinlikGorselleri = {
  ...
  'takim-gelisim': [
    { slug: 'etkinlik/takim-gelisim-etkinlikleri', kapak: true },
    ...
    { slug: 'etkinlik/takim-gelisim-etkinlikleri-5-jpg', kapak: false },
  ],
  'wellbeing': [
    { slug: 'etkinlik/wellbeing-iyi-olus-etkinlikleri-1', kapak: true },
    ...
    { slug: 'etkinlik/wellbeing-iyi-olus-etkinlikleri-7', kapak: false },
